...
class Constants{
    ...
    public static $password_length = "Your password must be between 6 and 26 characters";
    public static $login_failed = "Your Username or your Password was incorrect";
} 